from cif_httpd.common import pull_token, jsonify_success, jsonify_unauth, jsonify_unknown, aggregate, VALID_FILTERS
from flask.views import MethodView
from flask import request, current_app, jsonify, g
from cifsdk_zmq.zeromq import ZMQ as Client
from cifsdk.client.dummy import Dummy as DummyClient
from cif.constants import ROUTER_ADDR, FEEDS_LIMIT, FEEDS_WHITELIST_LIMIT, HTTPD_FEED_WHITELIST_CONFIDENCE
